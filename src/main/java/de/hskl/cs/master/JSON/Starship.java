...
public class Starship {
	...
	public Starship(String title) {
		...
		public static Starship getStarshipFromApi(String url) {
			...
			String jsonStarship = client.target(url)
					.request(MediaType.APPLICATION_JSON).get(String.class);
			return gson.fromJson(jsonStarship, Starship.class);
		}
